...
describe("Field validators", () => {
    ...
    it("isRole", () => {
        let r = api_objects_1.Role.guest;
        let rstr = api_objects_1.Role[r];
    ...
    it("isCommodityType", () => {
        let r = api_objects_1.CommodityType.home;
        let rstr = api_objects_1.CommodityType[r];
    ...
    it("isSecurityType", () => {
        let r = api_objects_1.SecurityType.fund;
        let rstr = api_objects_1.SecurityType[r];
    ...
    it("isAccountType", () => {
        let r = api_objects_1.AccountType.cash;
        let rstr = api_objects_1.AccountType[r];
